...
const Messages = {
    en: {
        ...
        'container.error.same.orientation.touch': otherContainer => 'Container touches or overlaps container of same orientation: ' + otherContainer,
        'container.error.other.orientation.touch': otherContainer => 'Container touches container of other orientation: ' + otherContainer,
        'container.error.too.big.coordinate': maxCoordinate => 'Container coordinate must not be bigger than  ' + maxCoordinate,
    ...
    ru: { //not translated yet
        ...
        'crossword.container.orientation': 'Направление',
        'crossword.container.column': 'Колонка',
        'crossword.container.row': 'Ряд',
        'crossword.container.length': 'Длина',

        'crossword.container.orientation.horizontal': 'Горизонтальный',
        'crossword.container.orientation.vertical': 'Вертикальный',
        ...
        'container.error.same.orientation.touch': otherContainer => 'Контейнер касается или накладывается на контейнер того же направления: ' + otherContainer,
        'container.error.other.orientation.touch': otherContainer => 'Контейнер касается контейнера другого направления: ' + otherContainer,
        'container.error.too.big.coordinate': maxCoordinate => 'Координата контейнера не должна быть более ' + maxCoordinate,
